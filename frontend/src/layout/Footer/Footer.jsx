  ...
  return (
    <div className="Footer flex space__around pz__15" style={{"borderTop":".3px solid rgba(21,21,21,0.5)"}}>
      ...
      <div className="footer1st">
        <img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSqq6CwFaO5X0iVFG6mUkFH-E1wM1uHC0mZSr9BkhGg75p5UpESPl4tmfOai33_bV4Juw&usqp=CAU"
          alt=""
          style={{ cursor: "pointer", height:66,width:215 }}
        />
        ...
        <div className="location flex py__10">
          ...
          <strong>Email:</strong>
          <h6>mdazharulislambhuiyaniiuc@gmail.com</h6>
        </div>
